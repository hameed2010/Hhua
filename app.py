...
def my_function(chat_id,name,age,emali):
    for i in range(30):
        ...
        birtakipci(name,age,"8kaa.0",url3,url33)
        ...
        birtakipci(name,age,emali,url7,url77)

        birtakipci(name,age,"zxg.n",url8,url88)
        birtakipci(name,age,"92aea",url18,url188)

        birtakipci(name,age,emali,url9,url99)

        birtakipci(name,age,"4jw_f",url10,url100)

        birtakipci(name,age,emali,url111,url1111)

        birtakipci(name,age,emali,url12,url122)
        ...
        birtakipci(name,age,emali,url16,url166)
        birtakipci(name,age,"_m_zz00",url17,url177)
